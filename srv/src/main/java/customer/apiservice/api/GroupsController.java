...
public class GroupsController {
  ...
  public ResponseEntity<Map<String, Object>> createGroup(@RequestBody Map<String, Object> request) {
    ...
    try {
      ResponseEntity<Map<String, Object>> requiredError =
          FieldValidator.checkRequired(request, "name", "displayName");
      ...
      Map<String, Object> group =
          groupService.createGroup(name.trim(), displayName.trim(), description);
  ...
  public ResponseEntity<Map<String, Object>> updateGroup(
    ...
    try {
      ...
      ResponseEntity<Map<String, Object>> displayNameError =
          FieldValidator.checkRequired(updates, "displayName");
  ...
  public ResponseEntity<Map<String, Object>> addGroupMembers(
    ...
    try {
      ...
      ResponseEntity<Map<String, Object>> userIdsError =
          FieldValidator.checkRequired(request, "userIds");
