...
//REVIEW: Comments from other files still apply
  ...
  public List<Map<String, Object>> findGroups(int startIndex, int count, String search) {
  ...
  private SqlAndParams buildGroupsQuery(
      boolean countOnly, int startIndex, int count, String search) {
  ...
  public void insertGroup(Map<String, Object> group) {
    ...
    log.info("Group inserted successfully: ID={}, name={}", group.get("id"), group.get("name"));
  }
  ...
  public List<Map<String, Object>> getAllGroups() {
    String sql = "SELECT ID, DISPLAY_NAME, DESCRIPTION FROM USER_GROUPS";
